...
const TimelineItemList = _a => {
  ...
  const itemsList = mergedItems.filter(item => !!item).map((item, idx) => {
    ...
    return /*#__PURE__*/React.createElement(TimelineItem, Object.assign({
      className: classNames([className, !reverse && !!pending ? pendingClass : readyClass, getPositionCls((_a = item === null || item === void 0 ? void 0 : item.position) !== null && _a !== void 0 ? _a : '', idx)])
    }, item, {
